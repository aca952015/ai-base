...
const quickLinks = [
  ...
  { name: "知识工作台", product: "LightRAG", url: "http://knowledge.localhost:8080/webui", icon: NotebookTabs, external: true },
  { name: "链路追踪", product: "Jaeger", url: "https://jaeger.localhost.pomerium.io:8443", icon: Activity, external: true },
];

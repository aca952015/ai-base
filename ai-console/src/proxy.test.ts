...
function wecomSessionRequest(pathname: string, email = "employee@bluetron.cn") {
...
describe("console proxy", () => {
  it.each(["/auth/wework", "/auth/wework/complete?result=opaque", "/auth/wework/status?result=failed"])(

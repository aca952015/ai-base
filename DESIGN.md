...
- Core routes/screens: `/`、`/components`、`/agents`、`/account`、`/client-setup`、`/capabilities`、`/data`、`/evaluations`、`/observability`、`/authentication`、`/model-channels`、`/mcp`、`/integrations`、`/connectors`、`/settings`、`/settings/lightrag`

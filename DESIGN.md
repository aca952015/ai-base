...
- Core routes/screens: `/`、`/components`、`/agents`、`/account`、`/client-setup`、`/capabilities`、`/data`、`/evaluations`、`/observability`、`/authentication`、`/model-channels`、`/mcp`、`/integrations`、`/integrations/wecom-authentication`、`/integrations/feishu`、`/integrations/dingtalk`、`/connectors`、`/settings`、`/settings/lightrag`
